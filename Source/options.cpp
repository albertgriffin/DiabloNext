...
GameplayOptions::GameplayOptions()
    ...
    , runInTown("Run in Town", OptionEntryFlags::CantChangeInMultiPlayer, N_("Fast Walk Outside Combat"), N_("Enable jogging/fast walking when no recent combat is nearby. This keeps normal walk speed while fighting."), false)
